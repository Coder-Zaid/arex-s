  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        ...
        <Card className="bg-white/10 backdrop-blur shadow-lg border-0">
          <form onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-white/20 text-white placeholder-white/70 border-white/30 focus:ring-white"
                  />
                </div>
            ...
            <CardFooter className="flex-col gap-4 text-white">
              <Button 
                type="submit" 
              ...
              <div className="relative w-full my-2">
                ...
                <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/10 px-2 text-xs text-white">
                  or continue with
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 w-full">
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button
                    type="button"
                    variant="outline"
                    className="flex items-center justify-center gap-2 w-full bg-white/20 text-white border-white/30 hover:bg-white/30"
